        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {packages.map((pkg, index) => (
            ...
            >
              ...
              {/* AI-Generated Package Images Section */}
              <div className="mb-8 relative z-10">
                <div className="flex items-center justify-center h-48">
                  {images[pkg.packageType] ? (
                    <motion.div
                      className="relative"
                    ...
                    >
                      <img
                        src={images[pkg.packageType]}
                        alt={`${pkg.name} Course Package`}
                        className="w-40 h-40 object-contain rounded-lg shadow-2xl"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent rounded-lg"></div>
                    </motion.div>
                  ) : (
                    <div className="w-40 h-40 bg-gray-800 rounded-lg flex items-center justify-center border border-gray-600">
                      <div className="text-center">
                        ...
                        <p className="text-xs text-gray-500 font-jetbrains-mono mt-1">
