          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <p className="font-jetbrains-mono text-onyx/70 leading-relaxed group-hover:text-onyx transition-colors duration-300">
                  {feature.description}
                </p>
              </motion.div>
            ))}
            ...
            {processSteps.map((step, index) => (
              ...
              >
                ...
                <div className="flex-1 bg-white/10 rounded-lg p-6 backdrop-blur-sm border border-onyx/20 hover:bg-white/20 transition-all duration-300">
                  ...
                  <p className="font-jetbrains-mono text-onyx/80 leading-relaxed">
                    {step.description}
                  </p>
                </div>
              </motion.div>
